...
export default function SkillSystemEditor() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            const enSnap = await getDocs(collection(db, 'skillSystem'));
            const jpSnap = await getDocs(collection(db, 'skillSystemjp'));
    ...
    const handleSave = async () => {
        try {
            ...
            await save(dataEn, 'skillSystem');
            await save(dataJp, 'skillSystemjp');
            ...
            {Object.keys(data).map((sectionId) => {
                ...
                return (
                    <div key={sectionId} className="bg-light p-3 my-3 border rounded">
                        ...
                        {/* For sk01 - title/description pairs */}
    ...
    return (
        <Container className="py-5 px-4">
            <h2 className="text-center mb-4">🛠️ Edit "Specific Skill System" Content</h2>
